...
public class HomeEventsAcquiredRecyclerViewAdapter extends SimpleRecyclerViewAdapter {

    private static final String TAG = HomeEventsAcquiredRecyclerViewAdapter.class.getSimpleName();

    public HomeEventsAcquiredRecyclerViewAdapter(List<MyItem> eventItems, Activity activity) {
